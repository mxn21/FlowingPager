...
//        mWidth = w - getPaddingLeft() - getPaddingRight();
    ...
    private void initValue() {
        ...
        mRadius = mWidth / 2 -  getPaddingLeft()  ;
        ...
        float space = (float) ((mRadius +getPaddingLeft())/ Math.sqrt(2) - mPadding); //矩形宽高的一半
        mRectLT = mRadius +getPaddingLeft()- space;
        float rectRB = mRadius +getPaddingLeft()+ space;
